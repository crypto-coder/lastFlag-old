...
INSERT INTO `lastFlag`.`Currency` (`otAssetID`, `name`, `totalCreated`)
VALUES ('dky86RGUPSAhdjcf6AyDtNtiFLvzfMdMa83b53WLXbI', 'hacker coins', 100);
...
INSERT INTO `lastFlag`.`Account` (`otNymID`, `otAccountID`, `name`, `accountType`, `balance`, `balanceDate`, `userID`, `currencyID`)
VALUES ('FJolEMvVujXHV6f0LAGLLCWM5gG4n8EjEVRF4OHRN5D', 'QfOkqY7X05pSc7asfsv15w4fWThVKnpLHXYDj1G3fJh', 'Hackercoin - Issuer Account', 'I', -100, CURDATE(), 1, 1);
